...
<%@page import="com.tthshop.entities.Admin"%>
<!DOCTYPE html>
<html>
<head>
...
<meta name="description" content="Trang chủ admin">
...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<script src="static/admin/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
	<!-- jQuery Knob Chart -->
	...
	<!-- Bootstrap WYSIHTML5 -->
	<script src="static/admin/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
	<!-- Slimscroll -->
